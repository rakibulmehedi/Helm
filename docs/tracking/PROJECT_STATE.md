...
## 5. Active Modules
- Phase 7: Freelancer Income Pipeline (7a data layer DONE, 7b CRUD UI DONE, 7c list+filter DONE; 7d–7e pending)
  ...
  - /income route wired; minimal dashboard navigation entry added
